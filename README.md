...
```
56911beca5d8bc32cab7997c976e7b097d316ce7f6506e8f472003b89d6e552b
```
...
## ⚠️ USB writes are REAL by default
...
and displays the exact DiskPart script but **never executes it and never touches a disk** — the
...
apply in **both** modes — all enforced in the disk service, not just the UI:
...
- **250 automated tests** cover path validation, framework validation, ADK detection and the 1809
  ...
  parsing, the `ERASE DISK <n>` phrase validator, protected-disk rules, and the simulation path —
